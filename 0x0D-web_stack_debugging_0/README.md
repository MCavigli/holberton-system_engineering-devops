...
* [Ubuntu 14.04 (Note that Docker for Ubuntu 14 is deprecated and you will have to make some adjustments to the instructions when installing)](https://intranet.hbtn.io/rltoken/ynOBcBBvuYZPm9lSHFNcoQ)
...
Be sure to read the [Docker concept page](https://intranet.hbtn.io/concepts/65).
